 ...
 * Fecha:           Marzo 2026
 *
 * Archivo:         mxmOmpMPIfxc.c
 * Descripcion:
 *   Programa principal para multiplicacion de matrices con MPI + OpenMP usando
 *   el algoritmo Filas x Columnas (FxC).
 *
 *   El modelo es MASTER-WORKER (identico a mxmOmpMPIfxt.c en estructura):
 ...
 *                           su parte de C con FxC + OpenMP y la devuelven.
 *
 * Compilacion:
 *   mpicc -o mxmOmpMPIfxc mxmOmpMPIfxc.c moduloMPI.c -lm -fopenmp
 *
 * Ejecucion:
 *   mpirun -hostfile filehost -np <p> ./mxmOmpMPIfxc <DimMatriz> <NumHilos>
 ************************************************************************************************/
...
int main(int argc, char *argv[]) {
     ...
     * Solo el rank 0 entra aca. Verifica que N sea divisible por workers,
     * reserva memoria, inicializa A y B, y calcula cuantas filas le tocan a cada uno.
     *===================================================================================*/
    if (idProceso == MASTER) {
    ...
    if (idProceso > MASTER){
        ...
        /*==================================================================================
         * 5. Multiplicar con FxC + OpenMP
         * mxmOmpFxC NO transpone B. Accede a las columnas de B saltando D posiciones
         * en cada iteracion del ciclo interno  mas cache misses que FxT.
         * El bucle de filas se paraleliza con nH hilos OpenMP.
         *=================================================================================*/
